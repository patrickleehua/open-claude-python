"""Dream consolidation prompt builder.

Ported from Claude-Code-rev/src/services/autoDream/consolidationPrompt.ts.
"""
...
def build_consolidation_prompt(
    ...
    The 4-phase dream flow: Orient → Gather → Consolidate → Prune.
    """
